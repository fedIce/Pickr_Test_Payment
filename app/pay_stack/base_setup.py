...
from app.pay_stack.errors import *
...
class PayStack:
    ...
    def __init__(self, authorization_key=None):
        if authorization_key:
            ...
            self._PAYSTACK_AUTHORIZATION_KEY = os.getenv('PAYSTACK_API_TEST_SECRET_KEY', None)
    ...
    def _headers(self):
        return {
            ...
            "user-agent": "pickr-{}".format(__version__)
        }
    ...
    def _handle_requests(self, url, method: Methods, data = None):
        ...
        if not request:
            raise InvalidMethodError("request method not recorgnized or implemented")
