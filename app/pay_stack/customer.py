from app.pay_stack.base_setup import PayStack


class Customer(PayStack):
    def create(self, email, first_name=None, last_name=None, phone=None):
        ...
        return self._handle_requests("POST", url, payload)
    ...
    def update(self, user_id, email, first_name=None, last_name=None, phone=None):
        ...
        return self._handle_requests("PUT", url, payload)
    ...
    def getall(self, pagination=10):
        ...
        return self._handle_requests("GET", url)
